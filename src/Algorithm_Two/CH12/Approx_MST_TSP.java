...
// Prim의 최소 비용 신장 트리 알고리즘을 이용하여
// 해밀토니안 회로를 구하는 근사 외판원 알고리즘
public class Approx_MST_TSP {
    ...
    // Prim의 알고리즘을 이용하여 주어진 그래프의 최소 비용 신장 트리를 구한다
    // 매개변수: w - 주어진 그래프의 인접 행렬
    //       n - 그래프내의 정점들의 수
    ...
    public static void main(String[] args){
        ...
        // 최소 비용 신장 트리를 구하기 위해  Prim의 알고리즘을 호출한다
        node = primMST(graph, 4);
        ...
        // 깊이 우선 탐색으로 얻은 경로에 출발 정점을 추가하여 해밀토니안 회로를 완성한다
